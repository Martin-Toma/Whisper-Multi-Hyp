...
This is a modified version of official openai's whisper [Link text](https://github.com/openai/whisper), where decoder returns multiple hypothesis. The purpose of this modificatiton is studying the influence of llm on the rescoring of the hypothesis.
